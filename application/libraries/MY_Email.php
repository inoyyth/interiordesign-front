...
{
    // DB table
    private $table_email_queue = 'wp_email_queue';
     ...
     * @return  void
     */
    public function send_queue($newsletter)
    {
        ...
        foreach ($emails as $email)
        {
            ...
            $this->from('noreply@falcokonstruksi.com', 'Falco Konstruksi Official Website');
        ...
        $this->CI->db->update('wp_newsletter',array('is_sended'=>1),array('id'=>$newsletter->id));
